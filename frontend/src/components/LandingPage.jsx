    ...
    <div className="landing-page" data-testid="landing-page">
      <header className="landing-header">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 rounded-lg min-h-[44px] shadow-lg shadow-purple-500/50"
        >
          Sign in with Google
        </Button>
      </header>
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-12 py-6 text-lg rounded-lg shadow-lg hover:shadow-xl transition-all shadow-purple-500/50"
          >
            Get Started Free
          </Button>
