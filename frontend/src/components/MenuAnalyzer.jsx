              ...
              <div data-testid="menu-url-section">
                <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
                  <Input
                    ...
                    placeholder="Paste Menu URL (HTML, PDF, Word, Excel, etc.)"
                    value={menuUrl}
                  ...
                  >
                    {analyzingMenu ? "AI Exploring Menu..." : "Analyze Menu"}
                  </Button>
                </div>
                {analyzingMenu && (
                  <p style={{ fontSize: '0.85rem', color: '#7c3aed', marginTop: '0.5rem', fontStyle: 'italic' }}>
                    🔍 AI is crawling the website and exploring all menu sections...
                  </p>
                )}
              </div>
            ) : (
                ...
                <div style={{ display: 'grid', gap: '1rem' }}>
                  {menuResult.safe_dishes.map((dish, idx) => (
                    ...
                    >
                      ...
                      {dish.description && (
                        <p style={{ fontSize: '0.9rem', color: '#7c3aed', marginBottom: '0.5rem' }}>
                          {dish.description}
                        </p>
                      )}
