  ...
  return (
    <div className="scanner-page">
      <div className="page-header">
        <h1 className="page-title">⚡ Quick Allergy Analysis</h1>
        <p className="page-subtitle" style={{ textAlign: 'center' }}>
          Quickly analyze products
        </p>
      </div>

      {/* Quick Text Analysis Section */}
      ...
      {/* Product Label Scanner Section */}
      <div className="section" style={{ marginTop: '3rem' }}>
        <h2 className="section-title">📷 Product Label Scanner</h2>
          ...
          <div className="animated-border-content" data-testid="image-upload-section">
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
                <label htmlFor="label-image" className="upload-button">
                  ...
                  <div style={{ display: 'grid', gap: '0.75rem' }}>
                    {imageResult.alternatives.map((alt, idx) => (
                      <div 
                        key={idx} 
                        className="alternative-item" 
                        data-testid={`image-alternative-${idx}`}
                        style={{ 
                          background: 'rgba(168, 85, 247, 0.1)', 
                          border: '1px solid rgba(168, 85, 247, 0.3)',
                          padding: '1rem',
